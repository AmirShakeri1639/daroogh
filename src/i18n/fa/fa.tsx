  ...
  fa: {
    translation: {
      general: {
        ...
        systemFullTitle: 'سامانه الکترونیکی داروخانه داروگ',
        daroog: 'داروگ',
        tabadol: 'تبادل',
      ...
      error: {
        ...
        network: 'مشکلی پیش آمده. لطفا اتصال اینترنت خود را بررسی کنید.',
      ...
      alerts: {
        ...
        ExchangeAlertPart3:
          ') محصولات مورد نیاز جهت تبادل را انتخاب نمایید. در صورت تمایل میتوانید از تب ( ',
        ...
        FavoritesAlert:
          'داروساز عزیز٬ با ثبت داروها یا دسته بندی های دارویی مورد علاقه خود به هوش مصنوعی داروگ کمک می کنید تابهترین لیست ها را منطبق با علایقتان برای داشتن تبادلی آسان تر و مطلوب تر شما نمایش بدهد.',
        PrescriptionAlert:
        ...
        useAi:
          'هوش مصنوعی داروگ میتواند عملیات انتخاب از سبد عرضه شما را به صورت خودکار و بر اساس علایق داروخانه مقابل٬ انجام دهد. عملیات متعادل کردن سبدهای تبادل با درصد اختلاف مجاز نیز در صورت امکان صورت خواهد پذیرفت. ',
        ...
        findJobAlert:
          'در این بخش میتوانید از میان فرصت های شغلی ارائه شده توسط داروخانه ها با بررسی جزئیات٬ موارد مد نظرتان را انتخاب کنید و با آن داروخانه ها جهت هماهنگی های لازم تماس بگیرید.',
        countAlert:
          'در نظر داشته باشید که تعداد را بر اساس کوچکترین واحد وارد نمایید. مثلا برای ثبت یک ورق استامینوفن باید عدد ۱۰ را وارد نمایید. یا مثلا برای یک جعبه ۱۰ ورقی از استامینوفن عدد ۱۰۰ را وارد نمایید. جهت انجام محاسبات لازم میتوانید از دکمه محاسبه استفاده نمایید',
      },
      ...
      file: {
        ...
        commitmentGuide:
          'لطفا فایل نمونه را برای تعهدنامه دانلود نموده و تصویر آن را پس از پر کردن فرم ارسال فرمایید.',
        state: {
          None: 'در دست بررسی',
          Confirmed: 'تایید',
