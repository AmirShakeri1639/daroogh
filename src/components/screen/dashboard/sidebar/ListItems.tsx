      ...
      <div className={menuContainer}>
        ...
        <Collapse in={isOpenReports} timeout="auto" unmountOnExit>
          ...
          <List component="div" className={linkWrapper}>
            {getListItem({
              Icon: FontAwesomeIcon,
              text: t('reports.acceptedPrescriptions'),
              selected: isOpenPageOfThisGroup('reports/accepted-prescriptions'),
              link: acceptedPrescriptionsReport,
              isNested: true,
              props: {
          ...
          <List component="div" className={linkWrapper}>
            {getListItem({
              Icon: FontAwesomeIcon,
              text: t('reports.allEmploymentApplicationsReport'),
              selected: isOpenPageOfThisGroup(allEmploymentApplicationsReport),
              link: allEmploymentApplicationsReport,
              isNested: true,
              props: {
                icon: faFileContract,
                size: 'lg'
