        ...
        <>
          {rolesArray.indexOf(Admin) >= 0 && (
            <>
              ...
              <ListItem
                button
                onClick={(): void => setIsOpenRoleMenu((val) => !val)}
              >
                <ListItemIcon>
              ...
              <Collapse in={isOpenRoleMenu} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  <ListItem
                    ...
                    className={nested}
                    onClick={(): void =>
                      setActivePage(DashboardPages.CREATE_ROLE)
                    }
                  >
                    <ListItemIcon>
                      <AddIcon />
              ...
              <Collapse in={isOpenUserMenu} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  <ListItem
                    ...
                    className={nested}
                    onClick={(): void =>
                      setActivePage(DashboardPages.CREATE_USER)
                    }
                  >
                    <ListItemIcon>
                  ...
                  <ListItem
                    ...
                    className={nested}
                    onClick={(): void =>
                      setActivePage(DashboardPages.USERS_LIST)
                    }
                  >
                    <ListItemIcon>
                      <GroupTwoToneIcon />
              ...
              <Collapse in={isOpenDrugMenu} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  <ListItem
                    ...
                    className={nested}
                    onClick={(): void =>
                      setActivePage(DashboardPages.CREATE_DRUG)
                    }
                  >
                    <ListItemIcon>
                      <AddCircle />
                  ...
                  <ListItem
                    ...
                    className={nested}
                    onClick={(): void =>
                      setActivePage(DashboardPages.DRUGS_LIST)
                    }
                  >
                    <ListItemIcon>
                      <EnhancedEncryption />
              ...
              <Collapse in={isOpenCategory} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  <ListItem
                    ...
                    className={nested}
                    onClick={(): void =>
                      setActivePage(DashboardPages.CATEGORY_LIST)
                    }
                  >
                    <ListItemIcon>
                      <AddToPhotosIcon />
              ...
              <Collapse in={isOpenPharmacyMenu} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  ...
                  <ListItem
                    ...
                    className={nested}
                    onClick={(): void =>
                      setActivePage(DashboardPages.PHARMACY_LIST)
                    }
                  >
                    <ListItemIcon>
                      <Business />
              ...
              <Collapse in={isOpenMessageMenu} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  ...
                  <ListItem
                    button
                    onClick={(): void =>
                      setActivePage(DashboardPages.MESSAGES_LIST)
                    }
                    className={nested}
                  >
                    <ListItemIcon>
