...
const Top10PharmacyForm: React.FC = () => {
  const classes = useStyles();
  const [value, setValue] = useState(0);
  const [url, setUrl] = useState('/Reports/GetTop10Pharmacy');
  ...
  const updateUrl = (): void => {
    setUrl(
      `/Reports/GetTop10Pharmacy?fromDate=${state.fromDate
        .convert('gregorian')
        .setLocale('en')
...
export default Top10PharmacyForm;
