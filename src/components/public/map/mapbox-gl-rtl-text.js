  ...
  (function (global, factory) {
    ...
    var asm = function (global, env, buffer) {
      ...
      function Y(a, d) {
        ...
        if ((c[h >> 2] | 0) <= 0 ? (g = Da(f) | 0, d = g + 1 | 0, e = Ab(d << 1) | 0, Ka(c[17593] | 0, e, d, 10, h) | 0, (c[h >> 2] | 0) <= 0) : 0) b[e + (g << 1) >> 1] = 0;
        else e = 0;
        E = i;
        return e | 0
      }
          ...
          switch (j | 0) {
            ...
            default: {
              ...
              if ((j | 0) < 2 ? (c[b + 120 >> 2] | 0) >= 0 : 0) {
                ...
                o = c[n >> 2] | 0;
                if ((a[t >> 0] | 0) != 0 ? (p = c[w >> 2] | 0, (c[p >> 2] | 0) <= 0) : 0) f = da(j, p, 0) | 0;
                else f = a[s >> 0] | 0;
                p = a[o >> 0] | 0;
                n = q + -1 | 0;
                l = p;
          ...
          a: do {
            if (!(($(c[h >> 2] | 0) | 0) << 24 >> 24)) {
              ...
              if (!j) t = p;
                ...
                g = b + 60 | 0;
                if (!((aa(g, b + 36 | 0, a[b + 69 >> 0] | 0, (j + q | 0) * 12 | 0) | 0) << 24 >> 24)) break;
                if ((q | 0) == 1) {
                  u = c[g >> 2] | 0;
                  c[u >> 2] = c[p >> 2];
                  c[u + 4 >> 2] = c[p + 4 >> 2];
              ...
              while (1) {
                ...
                if ((g | 0) <= 0) break a;
                if (!s) g = c[u >> 2] | 0;
                else g = (c[t + (s * 12 | 0) + 4 >> 2] | 0) - (c[t + ((g + -2 | 0) * 12 | 0) + 4 >> 2] | 0) | 0;
                q = t + (s * 12 | 0) | 0;
                j = c[q >> 2] | 0;
                r = j >>> 31;
                j = j & 2147483647;
        ...
        a: while (1) {
          b: while (1) {
            ...
            c: while (1) {
              d: while (1) {
                ...
                e: while (1) {
                  ...
                  f: while (1) {
                    ...
                    if (!u) p = p + (((l + -8294 | 0) >>> 0 < 4 | ((l & -4 | 0) == 8204 | (l + -8234 | 0) >>> 0 < 5)) & 1) | 0;
                    switch (i << 24 >> 24) {
                      case 13:
                      case 1:
                        break b;
              ...
              if (t) c[(c[M >> 2] | 0) + ((c[y >> 2] | 0) + -1 << 3) + 4 >> 2] = 1;
              if (c[I >> 2] & 4 | 0) {
                c[z >> 2] = j;
                c[A >> 2] = p
              }
      ...
      function ia(f, g) {
        ...
        i = c[D >> 2] | 0;
        y = f + 94 | 0;
        if ((a[y >> 0] | 0) != 0 ? (h = c[f + 136 >> 2] | 0, (c[h >> 2] | 0) <= 0) : 0) j = da(c[f + 132 >> 2] | 0, h, 0) | 0;
        else j = a[f + 93 >> 0] | 0;
        x = f + 240 | 0;
        c[x >> 2] = 0;
        if (($(c[g >> 2] | 0) | 0) << 24 >> 24) {
              ...
              b: do {
                switch (a[I + i >> 0] | 0) {
                  ...
                  case 7: {
                    h = i + 1 | 0;
                    if ((h | 0) < (H | 0)) {
                      if ((b[G + (i << 1) >> 1] | 0) == 13 ? (b[G + (h << 1) >> 1] | 0) == 10 : 0) break b;
                      ta(o, j)
                    }
                    break
                  }
        ...
        c: while (1) {
          ...
          d: do {
            switch (l << 24 >> 24) {
              ...
              case 7: {
                h = h | 128;
                if ((a[y >> 0] | 0) != 0 ? (z = c[w >> 2] | 0, (t | 0) >= (c[z >> 2] | 0)) : 0) j = da(c[u >> 2] | 0, z, t) | 0;
                else j = a[v >> 0] | 0;
                a[K + t >> 0] = j;
                j = t + 1 | 0;
                if ((j | 0) < (H | 0)) {
                  ...
                  if ((a[y >> 0] | 0) != 0 ? (A = c[w >> 2] | 0, (j | 0) >= (c[A >> 2] | 0)) : 0) i = da(c[u >> 2] | 0, A, j) | 0;
                  else i = a[v >> 0] | 0;
                  b[B >> 1] = i & 255;
                  ta(C, i);
                  g = i;
      ...
      function ja(d, e, f, g, h) {
        ...
        t = c[d + 72 >> 2] | 0;
        if ((c[d + 124 >> 2] | 0) > (e | 0)) {
          if ((a[d + 94 >> 0] | 0) != 0 ? (i = c[d + 136 >> 2] | 0, (c[i >> 2] | 0) <= (e | 0)) : 0) i = da(c[d + 132 >> 2] | 0, i, e) | 0;
          else i = a[d + 93 >> 0] | 0;
      ...
      function na(b, e, f, g, h) {
        ...
        a: do {
          switch (a[p + (q >>> 4) >> 0] | 0) {
            ...
            case 6: {
              if ((c[b + 328 >> 2] | 0) > 0) c[b + 332 >> 2] = c[b + 336 >> 2];
              c[e + 8 >> 2] = -1;
              c[e + 12 >> 2] = -1;
              c[e + 16 >> 2] = h + -1;
              i = g;
      ...
      function pa(a, b) {
        ...
        var d = 0,
          e = 0;
        e = c[a + 352 >> 2] | 0;
        if (!((e | 0) != 0 ? (d = I[e & 0](c[a + 356 >> 2] | 0, b) | 0, (d | 0) != 23) : 0)) d = tb(b) | 0;
      ...
      function sa(d, e) {
        ...
        b[e + 502 >> 1] = 0;
        h = d + 94 | 0;
        if ((a[h >> 0] | 0) != 0 ? (f = c[d + 136 >> 2] | 0, (c[f >> 2] | 0) <= 0) : 0) f = da(c[d + 132 >> 2] | 0, f, 0) | 0;
        else f = a[d + 93 >> 0] | 0;
        a[e + 504 >> 0] = f;
        if ((a[h >> 0] | 0) != 0 ? (g = c[d + 136 >> 2] | 0, (c[g >> 2] | 0) <= 0) : 0) f = da(c[d + 132 >> 2] | 0, g, 0) | 0;
        else f = a[d + 93 >> 0] | 0;
        f = f & 1;
        a[e + 506 >> 0] = f;
        a[e + 505 >> 0] = f;
      ...
      function va(e, f, g, h) {
        ...
        var i = 0;
        i = c[e + 492 >> 2] | 0;
        if (1 << (d[(c[(c[e >> 2] | 0) + 72 >> 2] | 0) + f >> 0] | 0) & 7864320 | 0) return;
      ...
      function ya(d, f, g) {
        ...
        if (!k) {
          ...
          while (1) {
            ...
            if ((c[(c[q >> 2] | 0) + (((j & 65535) + -1 | 0) * 24 | 0) >> 2] | 0) == (c[n >> 2] | 0)) j = j + -1 << 16 >> 16;
            else {
              h = p;
              l = 21;
              break
      ...
      function Ha(a, b, d, e, f) {
        ...
        if (!((a | 0) == 0 | (b | 0) < -1 | (e | 0) < 0) ? (g = (d | 0) == 0, !(g & (e | 0) > 0)) : 0) {
          do {
            if (!g) {
              if (!(a >>> 0 >= d >>> 0 & (d + (e << 1) | 0) >>> 0 > a >>> 0) ? !(d >>> 0 >= a >>> 0 & (a + (b << 1) | 0) >>> 0 > d >>> 0) : 0) break;
              c[f >> 2] = 1;
              f = 0;
              return f | 0
            }
        ...
        switch (l & 11) {
          case 0: {
            ...
            while (1) {
              j = k + -1 | 0;
              f = k + -2 | 0;
              if ((k | 0) > 1 ? (b[a + (j << 1) >> 1] & -1024) << 16 >> 16 == -9216 : 0) j = (b[a + (f << 1) >> 1] & -1024) << 16 >> 16 == -10240 ? f : j;
              f = j;
              do {
                n = f;
                f = f + 1 | 0;
              ...
              while (1) {
                ...
                do {
                  if (!z) {
                    ...
                    k = (k | 0) == 0 ? 0 : k + (l << 1) | 0;
                    j = j - l | 0;
                    if (a[s >> 0] | 0) h = (a[q + (l + -1 + (c[w >> 2] | 0)) >> 0] | 0) == 0 ? h : h | 2;
                    if (!(h & 10)) break;
                    if ((j | 0) > 0) {
                    ...
                    if (m) h = (1 << d[q + (l + -1 + (c[x >> 2] | 0)) >> 0] & 8194 | 0) == 0 ? h | 4 : h;
                    l = 8207 - (h & 1) << 16 >> 16;
                    if (h & 5) {
                      if ((j | 0) > 0) {
                        b[k >> 1] = l;
                    ...
                    k = (k | 0) == 0 ? 0 : k + (z << 1) | 0;
                    j = j - z | 0;
                    if (a[s >> 0] | 0) h = (1 << d[q + (c[w >> 2] | 0) >> 0] & 8194 | 0) == 0 ? h | 8 : h;
                    if (!(h & 10)) break;
                    if ((j | 0) > 0) {
                      b[k >> 1] = 8207 - (h >>> 1 & 1) << 16 >> 16;
                      k = k + 2 | 0
      ...
      function Pa(b, d) {
        ...
        do {
          if (b | 0) {
            ...
            e = c[e >> 2] | 0;
            d = b + 76 | 0;
            if ((h | 0) > 0 ? (i = c[d >> 2] | 0, (e | 0) != (i | 0)) : 0) ec(e | 0, i | 0, h | 0) | 0;
      ...
      function Ra(e, f) {
        ...
        do {
          if ((c[e + 116 >> 2] | 0) == 2) {
            ...
            q = i + (l & 1) | 0;
            g = e + 60 | 0;
            if (!((aa(g, e + 36 | 0, a[e + 69 >> 0] | 0, q * 12 | 0) | 0) << 24 >> 24)) return;
            n = c[g >> 2] | 0;
            m = 0;
            g = 126;
            k = 0;
          ...
          while (1) {
            ...
            if ((d[i + (c[m + (a * 12 | 0) >> 2] | 0) >> 0] | 0) >= (b & 255)) {
              ...
              while (1) {
                g = e + 1 | 0;
                if ((g | 0) >= (h | 0)) break;
                if ((d[i + (c[m + (g * 12 | 0) >> 2] | 0) >> 0] | 0) < (b & 255)) break;
                else e = g
              }
              f = e;
              while (1) {
        ...
        do {
          if (a | 0) {
            ...
            if ((b | 0) >= 0 ? (c[a + 220 >> 2] | 0) > (b | 0) : 0) {
              ...
              if (e | 0) {
                a = c[a >> 2] | 0;
                if ((b | 0) > 0) a = (c[a + (b * 12 | 0) + 4 >> 2] | 0) - (c[a + ((b + -1 | 0) * 12 | 0) + 4 >> 2] | 0) | 0;
                else a = c[a + 4 >> 2] | 0;
                c[e >> 2] = a
              }
              e = f >>> 31;
      ...
      function Wa(a, d, e) {
        ...
        if ((c[a + 332 >> 2] | 0) > 0) {
          ...
          while (1) {
            ...
            if ((g | 0) > 1) j = c[m + ((g + -2 | 0) * 12 | 0) + 4 >> 2] | 0;
            else j = 0;
            i = (f | 0) > 0;
            h = c[m + (l * 12 | 0) + 4 >> 2] | 0;
            while (1) {
      ...
      function Ya(a, d, e, f, g) {
        ...
        if (!((a | 0) == 0 | (d | 0) < -1) ? (h = (e | 0) == 0, !((f | 0) < 0 | h & (f | 0) != 0)) : 0) {
          ...
          do {
            if (!h) {
              if (!(a >>> 0 <= e >>> 0 & (a + (d << 1) | 0) >>> 0 > e >>> 0) ? !(e >>> 0 <= a >>> 0 & (e + (f << 1) | 0) >>> 0 > a >>> 0) : 0) break;
              c[g >> 2] = 1;
              n = 0;
              E = o;
              return n | 0
          ...
          pb(i, a, d) | 0;
          if ((h | 0) > (d | 0)) fc(i + (d << 1) | 0, 0, h - d << 1 | 0) | 0;
          ab(i, d, m, n);
      ...
      function $a(a, c) {
        ...
        while (1) {
          if ((f | 0) >= (c | 0)) break;
          e = b[a + (f << 1) >> 1] | 0;
          if ((f | 0) < (g | 0) & e << 16 >> 16 == 1604 ? (ib(b[a + (f + 1 << 1) >> 1] | 0) | 0) != 0 : 0) h = 6;
          else if (jb(e) | 0) h = 6;
          if ((h | 0) == 6) {
            h = 0;
            d = d + -1 | 0
      ...
      function cb(a, e, f, g) {
        ...
        while (1) {
          ...
          if ((h + 1200 & 65535) < 176) {
            ...
            if (h << 16 >> 16) b[k >> 1] = h
          } else if ((h + 400 & 65535) < 141) b[k >> 1] = b[1360 + (i + -65136 << 1) >> 1] | 0;
          j = j + 1 | 0
        }
        l = e + -1 | 0;
        w = l;
        ...
        while (1) {
          if ((l | 0) == -1) break;
          o = h & 65535;
          if (!((o & 65280 | 0) == 0 ? ((_a(b[a + (l << 1) >> 1] | 0) | 0) & 4) == 0 : 0)) y = 13;
          do {
            if ((y | 0) == 13) {
              y = 0;
              n = l + -1 | 0;
              ...
              if ((m | 0) != 1) {
                ...
                i = b[m >> 1] | 0;
                if (gb(i) | 0)
                  if ((o & 2 | 0) == 0 | (n & 1 | 0) == 0 | (i & -2) << 16 >> 16 == 1612) p = 0;
      ...
      function wb(a) {
        ...
        if ((d | 0) == 7) c = ((e[45584 + (c << 1) >> 1] | 0) << 2) + (a & 31) | 0;
          ...
          if (!(c[17705] & 4)) {
            ...
            e: do {
              if (e) {
                ...
                while (1) {
                  d = c[a >> 2] | 0;
                  if (d >>> 0 <= e >>> 0 ? (q = a + 4 | 0, (d + (c[q >> 2] | 0) | 0) >>> 0 > e >>> 0) : 0) break;
                  a = c[a + 8 >> 2] | 0;
                  if (!a) {
                    r = 128;
                    break e
      ...
      function Db(a, b) {
        ...
        if (!(m & 3)) {
          ...
          if (d >>> 0 >= (b + 4 | 0) >>> 0 ? (d - b | 0) >>> 0 <= c[17714] << 1 >>> 0 : 0) return a | 0;
          a = 0;
          return a | 0
        }
        if (d >>> 0 >= b >>> 0) {
